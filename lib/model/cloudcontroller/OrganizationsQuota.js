...
class OrganizationsQuota extends CloudControllerBase {
  ...
  constructor(endPoint) {
     ...
     * {@link http://apidocs.cloudfoundry.org/213/organization_quota_definitions
                /list_all_organization_quota_definitions.html}
     *
  ...
  getQuotaDefinitions() {
     ...
     * {@link http://apidocs.cloudfoundry.org/213/organization_quota_definitions
                /retrieve_a_particular_organization_quota_definition.html}
     *
  ...
  getQuotaDefinition(guid) {
    ...
    /**
     * Add a Quota
     * {@link http://apidocs.cloudfoundry.org/222/organization_quota_definitions
              /creating_a_organization_quota_definition.html}
     *
  ...
  add(quotaOptions) {
     ...
     * {@link http://apidocs.cloudfoundry.org/222/organization_quota_definitions
                /delete_a_particular_organization_quota_definition.html}
     *
