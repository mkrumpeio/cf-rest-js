...
class UserProvidedServices extends CloudControllerBase {
  ...
  constructor(endPoint) {
    ...
    /**
     * Get Services
     * {@link http://apidocs.cloudfoundry.org/217/user_provided_service_instances
                  /list_all_user_provided_service_instances.html}
     *
  ...
  getServices() {
     ...
     * Get a Service
     * {@link http://apidocs.cloudfoundry.org/217/user_provided_service_instances
                    /retrieve_a_particular_user_provided_service_instance.html}
     *
  ...
  getService(guid) {
     ...
     * {@link http://apidocs.cloudfoundry.org/217/user_provided_service_instances
                /creating_a_user_provided_service_instance.html}
     *
  ...
  add(upsOptions) {
     ...
     * {@link http://apidocs.cloudfoundry.org/217/user_provided_service_instances
                    /delete_a_particular_user_provided_service_instance.html}
     *
  ...
  remove(guid) {
     ...
     * {@link http://apidocs.cloudfoundry.org/221/user_provided_service_instances
                      /list_all_service_bindings_for_the_user_provided_service_instance.html}
     *
     * @example
     * var filter = {
