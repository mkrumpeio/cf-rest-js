...
// http://apidocs.cloudfoundry.org/214/spaces/list_all_spaces.html}
  ...
  getSpaces(filter) {
    ...
    const url = `${config.cloudUrl}/v2/spaces`;
    let qs = {};
...
// http://apidocs.cloudfoundry.org/214/spaces/retrieve_a_particular_space.html}
  ...
  getSpace(guid) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}`;
    const options = {
      method: 'GET',
      url: url,
      headers: {
...
// http://apidocs.cloudfoundry.org/214/spaces/list_all_routes_for_the_space.html}
     *
     * @example
     *      qs: {
  ...
  getSpaceRoutes(guid, filter) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}/routes`;
    let qs = {};
...
// http://apidocs.cloudfoundry.org/214/spaces/list_all_apps_for_the_space.html}
  ...
  getSpaceApps(guid, filter) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}/apps`;
    let qs = {};
...
// http://apidocs.cloudfoundry.org/214/spaces/list_all_services_for_the_space.html}
     *
     * @example
     *      qs: {
                'q': 'name:' + params.appName,
  ...
  getSpaceServices(guid, filter) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}/services`;
    let qs = {};
...
// http://apidocs.cloudfoundry.org/214/spaces/list_all_service_instances_for_the_space.html}
     *
     * @example
     *      qs: {
                'q': 'name:' + params.appName,
  ...
  getSpaceServiceInstances(guid, filter) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}/service_instances`;
    let qs = {};
...
// http://apidocs.cloudfoundry.org/222/spaces/get_space_summary.html}
  ...
  getSummary(guid) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}/summary`;
    const options = {
      method: 'GET',
      url: url,
      headers: {
...
// http://apidocs.cloudfoundry.org/222/spaces/retrieving_the_roles_of_all_users_in_the_space.html}
  ...
  getUserRoles(guid) {
    ...
    const url = `${config.cloudUrl}/v2/spaces/${guid}/user_roles`;
    const options = {
      method: 'GET',
      url: url,
      headers: {
...
// http://apidocs.cloudfoundry.org/222/spaces/creating_a_space.html}
  ...
  add(spaceOptions) {
    ...
    /**
     * Update a Space
// http://apidocs.cloudfoundry.org/222/spaces/update_a_space.html}
     *
...
// http://apidocs.cloudfoundry.org/222/spaces/associate_manager_with_the_space.html}
     *
     * @param  {String} guid   [Space uid]
  ...
  addManager(guid, managerGuid) {
    const url = `${config.cloudUrl}/v2/spaces/${guid}/managers/${managerGuid}`;
...
// http://apidocs.cloudfoundry.org/222/spaces/remove_manager_from_the_space.html}
     *
     * @param  {String} guid   [Space uid]
     * @param  {String} managerGuid [Manager uid]
     * @return {JSON}              [return a JSON response]
...
// http://apidocs.cloudfoundry.org/222/organizations/list_all_developers_for_the_organization.html}
     *
     * @param  {String} guid     [org guid]
     * @param  {Json} filter       [filter to search]
     * @return {Json}              [output]
  ...
  getDevelopers(guid, filter) {
    ...
    const url = `${config.cloudUrl}/v2/organizations/${guid}/developers`;
    let qs = {};
...
// http://apidocs.cloudfoundry.org/222/spaces/associate_developer_with_the_space.html}
     *
     * @param  {String} guid   [Space uid]
  ...
  addDeveloper(guid, developerGuid) {
    const url = `${config.cloudUrl}/v2/spaces/${guid}/developers/${developerGuid}`;
...
// http://apidocs.cloudfoundry.org/222/spaces/remove_developer_from_the_space.html}
     *
     * @param  {String} guid   [Space uid]
     * @param  {String} developerGuid [Developer uid]
     * @return {JSON}              [return a JSON response]
